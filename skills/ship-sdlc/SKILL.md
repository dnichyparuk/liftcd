...
This is a thin dispatcher to prevent context bloat. The actual execution logic lives in `sdlc:ship-workflow`.
...
3. Call the `invoke_subagent` tool to spawn the `sdlc:ship-workflow` subagent.
