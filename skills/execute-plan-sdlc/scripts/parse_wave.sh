...
[ ! -f "$LIB" ] && { echo "ERROR: Could not locate scripts/lib/wave-summary.js. Is the LiftCD plugin installed?" >&2; exit 2; }
   [ -z "$LIB" ] && [ -f "plugins/liftcd/scripts/lib/wave-summary.js" ] && LIB="plugins/liftcd/scripts/lib/wave-summary.js"
   PARSE_RESULT=$(node -e "
